    ...
    <div class="container">
        ...
        <?php if (isset($_GET['success'])): ?>
            <div class="popup-success">
                Payment success. Tiket online berhasil dibuat.
            </div>
        <?php endif; ?>
                ...
                <?php while ($row = $transactions->fetch_assoc()) { ?>
                    ...
                    <div class="ticket-history-card">
                        ...
                        <div class="ticket-history-content">
                            ...
                            <p><strong>Pembayaran:</strong> QRIS / <?= htmlspecialchars($row['payment_detail']); ?></p>

                            <?php if (!empty($row['ticket_code'])): ?>
                                <p><strong>Kode Tiket:</strong> <?= htmlspecialchars($row['ticket_code']); ?></p>
                            <?php endif; ?>
